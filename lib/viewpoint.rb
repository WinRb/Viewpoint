...
require 'ews/soap/ews_soap_get_streaming_events_response'
require 'ews/soap/ews_soap_get_streaming_events_notification.rb'
require 'ews/soap/ews_soap_get_user_settings_response'
...
require 'ews/soap/responses/get_streaming_event_response.rb'
