...
describe "Operations on Exchange Data Services" do
  ...
  it "generates CreateFolder XML" do
    @ews.should_receive(:do_soap_request).
      with(xml_matcher(load_soap("create_folder", :request)))
  ...
  it "generates CopyFolder XML" do
    @ews.should_receive(:do_soap_request).
      with(xml_matcher(load_soap("copy_folder", :request)))
  ...
  it "generates DeleteFolder XML" do
    @ews.should_receive(:do_soap_request).
      with(xml_matcher(load_soap("delete_folder", :request)))
  ...
  it "generates FindFolder XML" do
    @ews.should_receive(:do_soap_request).
      with(xml_matcher(load_soap("find_folder", :request)))
  ...
  it "generates GetFolder XML" do
    @ews.should_receive(:do_soap_request).
      with(xml_matcher(load_soap("get_folder", :request)))
  ...
  it "generates MoveFolder XML" do
    @ews.should_receive(:do_soap_request).
      with(xml_matcher(load_soap("move_folder", :request)))
  ...
  it "generates EmptyFolder XML" do
    @ews.should_receive(:do_soap_request).
      with(xml_matcher(load_soap("empty_folder", :request)))
